...
describe("Client", function () {
  ...
  describe("#_makeHostUrl", function () {
    ...
    it("should get host url when authentication is set.", function () {
      ...
      var port = "8983";
      //when
      var hostUrl = testClient._makeHostUrl(
        protocol,
        host,
        port,
        user,
  ...
  describe("#search", function () {
    ...
    it("should search data when query is object.", function (done) {
      //given
      var client = new Client({ core: "test" });
      var query = client.query().q({ text: "test", title: "test" });
      //when
      client.search(query, function (err, result) {
        //then
        expect(err).to.not.exist;
  ...
  describe("#terms", function () {
    it("should get terms data.", function (done) {
      //given
      var client = new Client({ core: "test" });
      var query = client.query().termsQuery({
        fl: "text",
        prefix: "te",
      });
      //when
  ...
  describe("#spell", function () {
    it("should get spell data.", function (done) {
      //given
      var client = new Client({ core: "test" });
      var query = client.query().df("title").spellcheckQuery({
        q: "tes",
        build: true,
        collate: true,
        maxCollations: 5,
  ...
  describe("#suggest", function () {
    it("should get suggest data.", function (done) {
      //given
      var client = new Client({ core: "test" });
      var query = client.query().suggestQuery({
        q: "tes",
        suggest: true,
